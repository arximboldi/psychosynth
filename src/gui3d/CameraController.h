...
class CameraController : public OIS::MouseListener, public OIS::KeyListener {
protected:	
	Ogre::Camera* m_camera;
public:
	CameraController(Ogre::Camera* camera = NULL) :
		m_camera(camera) {}
	
	virtual ~CameraController() {};

	const Ogre::Camera* getCamera() const {	return m_camera; }
