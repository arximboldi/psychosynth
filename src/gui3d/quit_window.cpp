...
FrameWindow* quit_window::create_window ()
{
    ...
    window->setSize    (USize(UDim(0, 240),    UDim(0, 120)));
    ...
    label->setSize(USize(UDim(0.8, 0), UDim(0, 20)));
    ...
    button_quit->setSize    ( USize(UDim(0.35, 0), UDim(0, 20)));
    ...
    button_cancel->setSize    (USize(UDim(0.35, 0), UDim(0, 20)));
    button_cancel->setWantsMultiClickEvents(false);

    window->addChild(label);
    window->addChild(button_quit);
    window->addChild(button_cancel);
