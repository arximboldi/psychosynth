...
public:
     ...
     */
    ring_sample_buffer(size_t size);
     ...
     */
    size_t read(read_ptr& r, sample_buffer& buf) const {
     ...
     */
    size_t read(read_ptr& r, sample_buffer& buf, size_t samples) const;
     ...
     */
    void write(const sample_buffer& buf, size_t samples);
     ...
     * @param factor The resampling factor: old_sample_rate / new_sample_rate.
     */
    void write_fast_resample(const sample_buffer& buf, size_t samples, float factor);
