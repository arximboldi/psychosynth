...
public:
     ...
     */
    void deinterleave (const sample* src, size_t n_frames, size_t num_chan);
     ...
     * @param num_chan The number of channels in the interleaved buffer.
     */
    void deinterleave (const sample* src, size_t start, size_t end, size_t num_chan);
     ...
     * @param n The index of the channel.
     */
    const sample* get_channel (size_t n) const {
	return m_data[n];
    }
     ...
     * @param n The index of the channel.
     */
    const sample* operator[] (size_t n) const {
	return m_data[n];
    }
     ...
     */
    void set_info(const audio_info& info, size_t size) {
