/**
 *  Time-stamp:  <2010-10-19 13:46:24 raskolnikov>
 *
 *  @file        algorithm.hpp
...
/**
   ...
   implementation when used with GIL constructs
*/
...
template <typename IL, typename OL>
GIL_FORCEINLINE
boost::gil::iterator_from_2d<OL> copy (boost::gil::iterator_from_2d<IL> first,
