...
\begin{mynote}[Autechre and generative music]\index{generative music}
  ...
  Data\index{PD, Pure Data} are graphical \emph{data-flow programming
  ...
  music. \index{data-flow programming}
\end{mynote}
...
is a data-flow based visual programming\index{data-flow programming}
\index{visual programming} environment mainly targeted at music
...
\ref{fig:autechre} in the preface showed an example of its
functioning. The author of Max/MSP later developed a Free Software
