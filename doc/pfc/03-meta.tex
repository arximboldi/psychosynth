...
as parameter. The \type{buffered\_*\_adapter} types \emph{aggregate} the
...
\ref{tab:perfacrn}. All the timings are represented in
$milliseconds$. The ``gain'' is computed as:
\begin{equation}
