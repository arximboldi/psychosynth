...
\begin{requirement}
  ...
  standard interfaces, at least using the \index{LADSPA (plug-in)}
  LADSPA standard\footnote{Linux Audio Developer's Simple Plugin:
    \url{http://www.ladspa.org/}}, but LV2\footnote{LADSPA Version 2:
    \url{http://lv2plug.in}}\index{LV2 (plug-in)} and
...
\begin{requirement}\index{block size}
